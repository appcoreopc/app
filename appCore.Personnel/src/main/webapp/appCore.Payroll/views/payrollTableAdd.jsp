...
<script language="javascript" src="../../js/viewmodal/Payroll/payrollTableAddViewModel.js"></script>
  ...
  <div class="formAddRow">
    ...
    <div class='columnDivider'>
      ...
      <div class="inputSectionForm">
        <input id="payrollTableCategoryAdd" type="text" class="validate[required, maxSize[10]]" data-bind="value : $root.addInfoCategory" placeholder="new category"/>
      </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="payrollTableDescriptionAdd" data-bind="value : $root.addInfoDescription" placeholder="new description"/>
      </div>
    </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="payrollTableTypeAdd" data-bind="value : $root.addInfoType" class="validate[required, maxSize[10]]" placeholder="new type"/>
      </div>
    </div>
...
<script type="text/html" id="PayrollTableEntityAddTemplate">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
            ...
            function init()
            {
                  ...
                  {  
                      vm = new PayrollTableInfoViewModel(coreModeEdit, globalViewModel);
                  }
                 else
                 {
                      vm = new PayrollTableInfoViewModel(coreModeInsert, globalViewModel);
                 }
            }
            
            function bind()
            {
                $("#payrollTableForm").setupViewBinding(vm, globalViewModel);
...
<form id="payrollTableForm">
  <div id="payrollTableMaintenance" data-bind="template : { name : templateToUse} ">
        </form>