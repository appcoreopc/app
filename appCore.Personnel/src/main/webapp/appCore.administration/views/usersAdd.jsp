        ...
        <div class="formRow">
        <div class="labelSection">Password</div><div class="inputSection"><input type="text" id="Password"
        data-bind="value: password" class="validate[required], maxSize[30]"/></div>
        </div>

        <div class="formRow">
        <div class="labelSection">Confirm password</div><div class="inputSection"><input type="text" id="ConfirmPassword"
        data-bind="value : confirmPassword" class="validate[required], maxSize[30]"/></div>
        </div>


        <div class="formRow">
        <div class="labelSection">Full Name</div><div class="inputSection"><input type="text" id="FullName"
        data-bind="value : fullName" /></div>
        </div>

        <div class="formRow">
        <div class="labelSection">Email</div><div class="inputSection"><input type="text" id="email"
