...
<script type="text/javascript">          
	...
	$(document).ready(function() 
	{
		...
		var request = ajaxCore.sendRequest(gridUrl + "/get", { id : value }, "get");
		...
		function getValidateData()
		{
			...
			{
				var ajaxCore = new AjaxCore(); 
				var request = ajaxCore.sendRequestType(gridUrl + "/saveOrUpdate", user, "post"); 
...
<div class="form dataEntry">
  ...
  <div class="sectionalForm"> <input type="hidden" id="Nid" />
