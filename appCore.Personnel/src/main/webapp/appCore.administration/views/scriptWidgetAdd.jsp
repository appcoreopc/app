...
<script language="javascript" src="../../js/viewmodal/Administration/scriptWidgetAddViewModel.js"></script>
...
<script type="text/html" id="infoUpdateTemplate">
  ...
  <div class="formRowList">
    ...
    <input type="text" id="scriptName" data-bind="value : scriptName" placeholder="scriptName"/>
    </div>
    </div>
  ...
  <div class="formAddRow">
    ...
    <div class='columnDivider'>
      ...
      <div class="inputSectionForm">
        <input id="scriptWidgetCategoryAdd" type="text" class="validate[required, maxSize[10]]" data-bind="value : $root.addInfoCategory" placeholder="new category"/>
      </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="scriptWidgetDescriptionAdd" data-bind="value : $root.addInfoDescription" placeholder="new description"/>
      </div>
    </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="scriptWidgetTypeAdd" data-bind="value : $root.addInfoType" class="validate[required, maxSize[10]]" placeholder="new type"/>
      </div>
    </div>
...
<script type="text/html" id="ScriptWidgetEntityAddTemplate">
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        function init()
        {
            vm = new ScriptWidgetInfoViewModel(globalViewModel);
        }

        function bind()
        {
            $("#scriptWidgetForm").setupViewBinding(vm, globalViewModel);
        }

        $("#accordianScriptWidget").accordion({collapsible : true, active: false});
        $("#" + formName).validationEngine();
    });

</script>

<form id="scriptWidgetForm">
  <div id="scriptWidgetMaintenance" data-bind="template : { name : templateToUse} ">
  </div>
</form>