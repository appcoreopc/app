var HolidayEntitlementTypeListViewModel = function (initView, data, globalViewModel, command) {
    ...
    self.gridId = "gridHolidayEntitlementType";
    self.data = data;
    ...
    function deleteCallBack(status, data, globalViewModel, codeType) {
        if (status == true) {
            ...
            var result = helper.deleteHolidayEntitlementType(data, successDeleteCallback);
        }
    }
    ...
    function updateFunction(data) {
        ...
        globalViewModel.applicationScopeType(coreApplicationTypeHolidayEntitlementTypeType);
        preparePageForLoading("holidayEntitlementTypeAdd.jsp");
    }
