 var CoreModuleListViewModel = function (initView, data, globalViewModel, command) { 
    
	var mode = initView;
    var self = this;
    self.gridUrl = globalHostname + "/app/Core/CoreModule";
    self.codeCommand = "#codeCommand";
    self.gridId = "gridCoreModule";
    self.data = data;
    ...
    function getView() {
        ...
        switch (mode) {
            case 0:
                var addLinkInfo = {
                    "text":"Add Core Module",
                    "commandId":'CoreModuleAdd',
                    "callback":function () {
                        goToAdd()
                    }
                };
    ...
    function deleteCallBack(status, data, globalViewModel, codeType) {
        if (status == true) {
            ...
            var result = helper.deleteCoreModule(data, successDeleteCallback);
        }
    }
    ...
    function updateFunction(data) {
        ...
        globalViewModel.applicationScopeType(coreApplicationTypeCoreModuleType);
        preparePageForLoading("coreModuleAdd.jsp");
    }
