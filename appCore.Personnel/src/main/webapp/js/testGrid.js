(function () {
    ...
    ko.testGrid = {
        ...
        ViewModel:function (configuration)
        {
            ...
            this.editTemplate = configuration.editTemplate;
            ...
            this.availableCountries = configuration.availableCountries;
                    ...
                    <table class=\"ko-grid\" cellspacing=\"0\">\
                        ...
                        <tbody data-bind=\"foreach: itemsOnCurrentPage\">\
                           ...
                           <!-- ko foreach: $parent.columns-->\
                                <!-- ko if: $data.renderTemplate != undefined || $data.renderTemplate != null -->\
                                    <td data-bind=\"template: { name : 'editTemplate', data : $parent[rowText] } \"></td>\
                               <!-- /ko -->\
                               <!-- ko ifnot: $data.renderTemplate != undefined || $data.renderTemplate != null -->\
