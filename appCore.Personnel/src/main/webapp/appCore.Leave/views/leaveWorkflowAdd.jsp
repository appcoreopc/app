...
<script language="javascript" src="../../js/viewmodal/Leave/leaveWorkflowAddViewModel.js"></script>
  ...
  <div class="formAddRow">
    ...
    <div class='columnDivider'>
      ...
      <div class="inputSectionForm">
        <input id="leaveWorkflowCategoryAdd" type="text" class="validate[required, maxSize[10]]" data-bind="value : $root.addInfoCategory" placeholder="new category"/>
      </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="leaveWorkflowDescriptionAdd" data-bind="value : $root.addInfoDescription" placeholder="new description"/>
      </div>
    </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="leaveWorkflowTypeAdd" data-bind="value : $root.addInfoType" class="validate[required, maxSize[10]]" placeholder="new type"/>
      </div>
    </div>
...
<script type="text/html" id="LeaveWorkflowEntityAddTemplate">
...
<script type="text/javascript">
    ...
    var formName = "leaveWorkflowForm";
    $(document).ready(function()
    {
            ...
            function init()
            {
                 ...
                 {  
                      vm = new LeaveWorkflowInfoViewModel(coreModeEdit, globalViewModel);
                  }
                 else
                 {
                      vm = new LeaveWorkflowInfoViewModel(coreModeInsert, globalViewModel);
                 }
            }
            
            function bind()
            {
                $("#leaveWorkflowForm").setupViewBinding(vm, globalViewModel);
...
<form id="leaveWorkflowForm">
  <div id="leaveWorkflowMaintenance" data-bind="template : { name : templateToUse} ">
        </form>