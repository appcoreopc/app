  ...
  <div class="formAddRow">
    ...
    <div class='columnDivider'>
      ...
      <div class="inputSectionForm">
        <input id="holidayReplacementTypeCategoryAdd" type="text" class="validate[required, maxSize[10]]" data-bind="value : $root.addInfoCategory" placeholder="new category"/>
      </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="holidayReplacementTypeDescriptionAdd" data-bind="value : $root.addInfoDescription" placeholder="new description"/>
      </div>
    </div>
    ...
    <div class='columnDivider'>
      ...
      <span class='req'>*</span>
      <div class="inputSectionForm">
        <input type="text" id="holidayReplacementTypeTypeAdd" data-bind="value : $root.addInfoType" class="validate[required, maxSize[10]]" placeholder="new type"/>
      </div>
    </div>
