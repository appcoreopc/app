        ...
        <div class="subHeader"> Employment Type Info </div>

        <div class="formRowSpacer"></div>

        <div id="accordianEmployentType" class="formRowAddContainer" data-bind="template : { name : 'infoAddTemplate'}, visible : enableAdd "></div>
