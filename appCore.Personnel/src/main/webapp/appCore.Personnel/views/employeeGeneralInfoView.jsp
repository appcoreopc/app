    <link href="../../css/themes/base/jquery.ui.all.css" media="screen" rel="stylesheet" type="text/css" />
        ...
        <div class="formRowViewTitle">
        <div class="viewLabelSectionTitle codeTitle"><i class="icon-plus-circle-1"></i><h4>General
        Information</h4></div><div
