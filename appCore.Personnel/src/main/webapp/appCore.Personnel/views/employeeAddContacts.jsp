        ...
        <div class="rightSection">
        <div class="inlineLabelSection">Ext No</div><div class="inlineLabelSection"><input type="text" data-bind="value:
        extNo" id="ExtNo" /></div>
        </div>
        </div>
        ...
        <div class="sectionalForm">
        <div class="leftSection">
        <div class="labelSection">City</div><div class="inputSection"><input type="text" data-bind="value: city"
        id="City" class="validate[required]"/></div>
        </div>

        <div class="rightSection">
        <div class="inlineLabelSection">Country</div><div class="inlineLabelSection">

        <select id="Country" data-bind="value: country" name="Country">
        ...
        <div class="rightSection">
        <div class="inlineLabelSection">Tel No</div><div class="inlineLabelSection"><input type="text" data-bind="value:
        telNo" id="TelNo" /></div>
        </div>
        </div>
