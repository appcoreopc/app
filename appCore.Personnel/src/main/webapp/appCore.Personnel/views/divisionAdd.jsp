        ...
        <div class="subHeader" data-bind="visible : showInfo"> Division Info </div>

        <div class="formRowSpacer"></div>


        <div id="accordianDivision" class="formRowAddContainer" data-bind="template : { name : 'infoAddTemplate'}, visible : (enableAdd && showInfo) "></div>
