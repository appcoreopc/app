...
public final class holidayGroup_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t{\r\n");
      out.write("\t\tvar appPath = \"/app/Core/Calendar/HolidayGroup\";\r\n");
      ...
      out.write("                                        name: { editable: true, type : \"string\" },\r\n");
      out.write("                                        description: { editable: true, type : \"string\" }\r\n");
      out.write("                                       \r\n");
      out.write("                                    }\r\n");
      out.write("                                }\r\n");
      out.write("                            }\r\n");
      ...
      out.write("\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t,\r\n");
      out.write("\t\t\t\t\t\tsaveChanges : function(e)\r\n");
      out.write("\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\tfor (var i=0; i < e.sender._data.length; i++)\r\n");
      out.write("\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\tcnt++;\r\n");
      out.write("\t\t\t\t\t\t\t\tconsole.log(cnt);\r\n");
      out.write("\t\t\t\t\t\t\t\tif (e.sender._data[i].isNew())\r\n");
      out.write("\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar holidayGroup = new HolidayGroup(); \r\n");
      out.write("\t\t\t\t\t\t\t\t\tholidayGroup.name =  e.sender._data[i].name;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tholidayGroup.description =  e.sender._data[i].description;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tajaxCore.sendRequest(hostname +  appPath + \"/add\", holidayGroup, \"get\");\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t\telse \r\n");
      out.write("\t\t\t\t\t\t\t\t{\r\n");
      out.write("\t\t\t\t\t\t\t\t\tvar holidayGroup = new HolidayGroup(); \r\n");
      out.write("\t\t\t\t\t\t\t\t\tholidayGroup.nid =  e.sender._data[i].nid;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tholidayGroup.name =  e.sender._data[i].name;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tholidayGroup.lastUpdate =  '2012-01-01';\r\n");
      out.write("\t\t\t\t\t\t\t\t\tholidayGroup.description =  e.sender._data[i].description;\r\n");
      out.write("\t\t\t\t\t\t\t\t\tajaxCore.sendRequestType(hostname +  appPath + \"/saveOrUpdate\", holidayGroup, \"post\");\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\t }\r\n");
      out.write("\t\t\t\t\t\t\r\n");
      ...
      out.write("\t\t\t{\r\n");
      out.write("\t\t\t\talert('we go');\r\n");
      out.write("\t\t\t\tvar grid = $(\"#grid\").data(\"kendoGrid\");\r\n");
      out.write("\t\t\t\tgrid.toolbar = [\"create\"];\r\n");
      ...
      out.write("\t<h1>Holiday Group Setup</h1>\r\n");
      out.write("\t\r\n");
      out.write("\t<div class=\"formRow\">\r\n");
      out.write("\t\tHoliday Group Maintenance\r\n");
      out.write("    </div>\r\n");
      out.write("\r\n");
      out.write("\t<div class=\"formRow\">\t\r\n");
      out.write("\t\t&nbsp;\r\n");
