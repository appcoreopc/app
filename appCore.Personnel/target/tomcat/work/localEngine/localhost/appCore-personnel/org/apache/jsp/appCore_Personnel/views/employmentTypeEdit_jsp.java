...
public final class employmentTypeEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("    var gridUrl = hostname + \"/app/Core/Job/EmploymentTypeInfo\";\r\n");
      out.write("\tvar employmentTypePage =  \"employmentType.jsp\";\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\tvar request = ajaxCore.sendRequest(hostname + \"/app/Core/Job/EmploymentType/get\", { id : value }, \"get\");\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t\t$(\"#Category\").val(data.category);\r\n");
      out.write("\t\t\t\t$(\"#Disabled\").attr(\"checked\", data.disableds);\r\n");
      out.write("\t\r\n");
      ...
      out.write("\t\t\t });\r\n");
      out.write("\t\t\t \r\n");
      out.write("\t\t\t $(\"#cancelBtn2\").click(function()\r\n");
      out.write("\t\t\t {\r\n");
      out.write("\t\t\t\tif (evt.handled !== true)\r\n");
      out.write("\t\t\t\t{\r\n");
      out.write("\t\t\t\t\tevt.handled = true; \r\n");
      ...
      out.write("\t\t\t\t\tif (result) \r\n");
      out.write("\t\t\t\t   preparePageForLoading(employmentTypePage);\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t });\r\n");
      out.write(" \t});\r\n");
      ...
      out.write("\t{\r\n");
      out.write("\t\tvar employmentTypeInfoData = [];\r\n");
      out.write("\t\r\n");
      out.write("        var grid = $(\"#grid\").data(\"kendoGrid\").dataSource.data();\r\n");
      out.write(" \t\t$.each(grid, function (i, dataItem) \r\n");
      out.write("\t\t{\r\n");
      out.write("\t\t\tvar employmentTypeInfo = new EmploymentTypeInfo(); \r\n");
      out.write("\t\t\temploymentTypeInfo.type = dataItem.type; \r\n");
      out.write("\t\t\temploymentTypeInfo.value = dataItem.value;\r\n");
      out.write("\t\t\temploymentTypeInfo.description = dataItem.description;\r\n");
      out.write("\t\t\temploymentTypeInfo.category = dataItem.category;\r\n");
      out.write("\t\t\temploymentTypeInfoData.push(employmentTypeInfo);\r\n");
      out.write("\t\t});\r\n");
      out.write("\t \t\t\r\n");
      out.write("\t\tvar employmentType = new EmploymentType(); \r\n");
      out.write("\t\temploymentType.nid = $(\"#Nid\").val();\r\n");
      out.write("\t\temploymentType.code = $(\"#Code\").val(); \r\n");
      out.write("\t\temploymentType.description = $(\"#Description\").val(); \r\n");
      out.write("\t\temploymentType.category = $(\"#Category\").val(); \r\n");
      out.write("\t\temploymentType.disabled = $('#Disabled').is(\":checked\"); \r\n");
      out.write("\t\temploymentType.employmentTypeInfo = employmentTypeInfoData; \t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\tvar ajaxCore = new AjaxCore(); \r\n");
      out.write("\t\tvar request = ajaxCore.sendRequestType(hostname + \"/app/Core/Job/EmploymentType/saveOrUpdate\", employmentType, \"post\"); \r\n");
      out.write("\t\t\r\n");
      ...
      out.write("\t<div class=\"labelSection\">Employment Type Code</div><div class=\"inputSection\"><input type=\"text\" id=\"Code\" value=\"Code\"/></div>\r\n");
      out.write("   </div> \r\n");
      out.write("\t\r\n");
      ...
      out.write("\r\n");
      out.write("\t<div class=\"formRow\">\r\n");
      out.write("\t\t<div class=\"labelSection\">Category</div><div class=\"inputSection\"><input type=\"text\" id=\"Category\" value=\"Category\"/></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("\r\n");
      out.write("\t\r\n");
      out.write("\t<div> \r\n");
      out.write("\t\t<div class=\"command\"><button type=\"button\" id=\"saveBtn\">Save</button>\r\n");
      out.write("\t\t<button type=\"button\" id=\"cancelBtn2\">Cancel</button>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("   \r\n");
      out.write("   <div>&nbsp;</div>\r\n");
      out.write("  \r\n");
      out.write("    <div>\r\n");
      out.write("\t <div> Employment Type Info  </div>\r\n");
