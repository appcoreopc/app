...
public final class roleList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <script language=\"javascript\" src=\"../../js/viewmodal/Administration/userRoleListViewModel.js\"></script>\r\n");
      ...
      out.write("        {\r\n");
      out.write("            getData(globalViewModel.userRole());\r\n");
      out.write("            globalViewModel.userRole.subscribe(function(newValue)\r\n");
      out.write("            {\r\n");
      ...
      out.write("\r\n");
      out.write("            var request = ajaxCore.sendRequest(globalUserList, companyId, \"get\");\r\n");
      out.write("            request.success(function(data)\r\n");
      out.write("            {\r\n");
      out.write("                var vm = new UserRoleListViewModel(coreModeList, data, globalViewModel);\r\n");
      out.write("                ko.applyBindings(vm, document.getElementById(\"userRightListDiv\"));\r\n");
      out.write("            });\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        </script>\r\n");
      ...
      out.write("        <h1>Role Maintenance</h1>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("        <div>\r\n");
      out.write("        <div id=\"userRightListDiv\" data-bind=\"dataGrid: gridViewModel\"></div>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        </div>\r\n");
    } catch (Throwable t) {
