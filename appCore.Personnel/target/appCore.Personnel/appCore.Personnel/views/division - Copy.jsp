...
<script type="text/javascript">          
	...
	$(document).ready(function() 
	{
		...
		var request = ajaxCore.sendRequest(hostname + "/app/Core/Division/list", null, "get");
			...
			request.success(function(data) 
			{
				  var grid = $("#grid").kendoGrid({
                        dataSource: {
						  ...
						  transport: {
                                read:  {
                                    url: hostname + "/app/Core/Division/list",
                                    dataType: "json"
                                },
                                update: {
                                    url: hostname + "/app/Core/Division/saveOrUpdate",
                                    dataType: "json"
                                },
                                destroy: {
                                    url: hostname + "/app/Core/Division/delete",
                                    dataType: "json"
                                },
                                create: {
                                    url: hostname + "/app/Core/Division/add",
                                    dataType: "json"
                                } 
							},
