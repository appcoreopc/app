...
<script type="text/javascript">          
	...
	$(document).ready(function() 
	{
		...
		if (value != null) 
		{
			...
			var request = ajaxCore.sendRequest(hostname + "/app/Core/Branch/get", { id : value }, "get");
	...
	function getValidateData()
	{
		...
		var ajaxCore = new AjaxCore(); 
		var request = ajaxCore.sendRequestType(hostname + "/app/Core/Branch/saveOrUpdate", branch, "post");
