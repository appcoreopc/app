    <script type="text/javascript">
        ...
        var request = ajaxCore.sendRequest(globalHostname + "/app/Core/Company/get", { id : value }, "get");
        ...
        var ajaxCore = new AjaxCore();
        var request = ajaxCore.sendRequestType(globalHostname + "/app/Core/Company/saveOrUpdate", company, "post");
