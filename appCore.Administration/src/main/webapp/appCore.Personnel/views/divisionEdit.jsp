<!DOCTYPE html PUBLIC "-//W3C//DTD HTMsL 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
...
<script type="text/javascript">          
	...
	$(document).ready(function() 
	{
		...
		if (value != null) 
		{
			...
			//var request =  $.ajax({type: "get", url: hostname + "/app/Core/Division/get", data: { id : value }, dataType : "json"
			//});
			
			var request = ajaxCore.sendRequest(hostname + "/app/Core/Division/get", { id : value }, "get");
	...
	function getValidateData()
	{
		...
		var ajaxCore = new AjaxCore(); 
		var request = ajaxCore.sendRequestType(hostname + "/app/Core/Division/saveOrUpdate", division, "post"); 
...
<div class="form dataEntry">
  ...
  <div class="sectionalForm"> 
   <div class="leftSection"><input type="hidden" id="Nid" name="Nid" />
    ...
    <div class="formRow">
		<div class="labelSection">Division Name</div><div class="inputSection"><input type="text" id="DivisionName" value="DivisionName"/></div>
    </div>
