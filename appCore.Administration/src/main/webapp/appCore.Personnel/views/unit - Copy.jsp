...
<script type="text/javascript">          
	...
	$(document).ready(function() 
	{
		...
		var request = ajaxCore.sendRequest(hostname + "/app/Core/Unit/list", null, "get");
			...
			request.success(function(data) 
			{
				  var grid = $("#grid").kendoGrid({
                        dataSource: {
						  ...
						  transport: {
                                read:  {
                                    url: hostname + "/app/Core/Unit/list",
                                    dataType: "json"
                                },
                                update: {
                                    url: hostname + "/app/Core//Unit/saveOrUpdate",
                                    dataType: "json"
                                },
                                destroy: {
                                    url: hostname + "/app/Core/Unit/delete",
                                    dataType: "json"
                                },
                                create: {
                                    url: hostname + "/app/Core/Unit/add",
                                    dataType: "json"
                                } 
							},
