...
insert into forms (formid, link, category_nid, companyId, type) values ('Company', '../../appCore.personnel/views/company.jsp', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Branch', '../../appCore.personnel/views/branch.jsp', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Division', '../../appCore.personnel/views/division.jsp', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Department', '../../appCore.personnel/views/department.jsp', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Section', '../../appCore.personnel/views/section.jsp', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Unit', '../../appCore.personnel/views/unit.jsp', 1, 1, 1);

insert into forms (formid, link, category_nid, companyId, type) values ('EmployeeList', '../../appCore.personnel/views/employeeList.jsp', 1, 1, 1);

insert into forms (formid, link, category_nid, companyId, type) values ('Industry Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=1', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Gender Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=2', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Race Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=3', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Salutation Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=4', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Religion Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=5', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Nationality Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=6', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Marital Status Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=7', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Level Code', '../../appCore.personnel/views/maintenanceCode.jsp?id=8', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Field Of ExpertiseCode', '../../appCore.personnel/views/maintenanceCode.jsp?id=9', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Family Relation Type', '../../appCore.personnel/views/maintenanceCode.jsp?id=10', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Employee Group', '../../appCore.personnel/views/maintenanceCode.jsp?id=11', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Holiday Group', '../../appCore.personnel/views/maintenanceCode.jsp?id=12', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Currency', '../../appCore.personnel/views/maintenanceCode.jsp?id=13', 1, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Configure Company', '../../appCore.personnel/views/companyConfigurator.jsp', 1, 1, 1);

insert into forms (formid, link, category_nid, companyId, type) values ('Job Setup', '../../appCore.personnel/views/jobSetup.jsp', 2, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Configure Employee Group', '../../appCore.personnel/views/configureEmployeeGroup.jsp', 2, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Grade', '../../appCore.personnel/views/grade.jsp', 2, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Employment Type', '../../appCore.personnel/views/employmentType.jsp', 2, 1, 1);

insert into forms (formid, link, category_nid, companyId, type) values ('HolidaySetup', '../../appCore.personnel/views/holidaySetup.jsp', 3, 1, 1);
insert into forms (formid, link, category_nid, companyId, type) values ('Configure Employee Holiday', '../../appCore.personnel/views/configureHolidayGroup.jsp', 3, 1, 1);
